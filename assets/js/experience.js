...
const exp = [
  ...
  },
  {
    ...
    time: "(Feb, 2017 - July, 2020)",
    desp: "<li>Worked on the organization Ecommerce App.</li><li>Designed a Stock Management System software.</li><li>Managed the organization website.</li>",
  },
  {
    title: "Internship",
    cardImage: "assets/images/experience-page/ascon.png",
    place: "Ascon",
    time: "(April, 2016 - Sept, 2016)",
